...
import ToggleMenuBtn from "../ToggleMenuBtn/index";
...
export default function ModalNav({ handleClose }: { handleClose: () => void }) {
  return (
    <Wrapper aria-label="Modal menu">
      <ToggleMenuBtn onClick={handleClose}>
        <X size={32} />
      </ToggleMenuBtn>
      <ContentTop>
        <Image
      ...
      <ContentBottom>
        <Nav aria-label="Secondary modal">
